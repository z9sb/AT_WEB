    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Typography level="body-sm">INFNET</Typography>
            <Typography level="body-xs">30 anos </Typography>
          </CardContent>
        </Card>
        <List
          size="sm"
        ...
        >
          <ListItem nested sx={{ width: { xs: "50%", md: 140 } }}>
            ...
            <List>
              <ListItem>
                <ListItemButton>Bacharelado</ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton>Mestrado</ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton>Tecnologo</ListItemButton>
              </ListItem>
            </List>
          </ListItem>
        </List>
